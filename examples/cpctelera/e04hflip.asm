...
border_colour equ &0010         ;; 0x10 (Border ID), 0x00 (Colour to set: White).
sprite_HxW    equ &1805         ;; Height (24, 0x18) and Width (5, 0x05) of the sprite in bytes.
sprite_end_x  equ 75            ;; x coordinate where sprite will bounce to the left
look_left     equ &01           ;; Looking Left
look_right    equ &00           ;; Looking right

;; ASCII zero-terminated String to be printed at the top of the screen
;;
str_demo: db "[ MODE 1 ] Sprite Flipping Demo",0
str_len      equ 31     ;; Length of the string
str_colour   equ &0001	;; Pen 1, Paper 0 (Black over background)
...
str_location equ pvideomem + (screen_W - str_len*2)/2 
...
g_sprites:
   ...
   dw g_spr_monsters_0  ;; Pointer to the sprite
   ;; Sprite 1 (monster 0)
   db look_right        ;; Direction towards the sprite is looking at
   dw g_spr_monsters_1  ;; Pointer to the sprite
...
read 'cpctelera/sprites/flipping/cpct_hflipSpriteM1.asm'

; read 'cpctelera/sprites/cpct_hflipSpriteM1_r.asm' ;; Alternative ROM-friendly version
...
initialize:
   ...
   ;; Set Palette
   ld    hl, g_spr_palette      ;; HL = pointer to the start of the palette array
   ...
   call  cpct_drawStringM1_f    ;; Draw the string (fast method)
...
drawEntity:
   ...
   xor   &01                     ;; Switch looking direction (0->1, or 1->0)
   ...
   call  cpct_hflipSpriteM1      ;; Flip the sprite

   ;; Sprite could also be flipped using ROM-friendly version, using this code
   ;; (read 'cpctelera/sprites/cpct_hflipSpriteM1_r.asm' must be added)
   ;ld    hl, sprite_HxW        ;; H = Sprite Height, L = Width
   ;call  cpct_hflipSpriteM1_r  ;; Flip the sprite
...
loop:
   call  cpct_waitVSYNC     ;; Synchronize with VSYNC
...
g_spr_palette: db 0x40, 0x54, 0x5c, 0x4c

; Tile g_spr_monsters_0: 20x24 pixels, 5x24 bytes.
g_spr_monsters_0: ; defs 5 * 24
	db 0x00, 0x00, 0x00, 0x00, 0x00
	db 0x00, 0x02, 0x22, 0x00, 0x00
	db 0x00, 0x03, 0x33, 0x00, 0x00
	db 0x00, 0x03, 0xff, 0x00, 0x00
	db 0x00, 0x03, 0xff, 0x00, 0x00
	db 0x00, 0x03, 0xf2, 0x00, 0x00
	db 0x00, 0x03, 0xff, 0x00, 0x00
	db 0x00, 0x03, 0x28, 0x00, 0x00
	db 0x00, 0x03, 0x78, 0x00, 0x00
	db 0x00, 0x01, 0x0f, 0x00, 0x00
	db 0x00, 0x07, 0xff, 0x0c, 0x0e
	db 0x00, 0x2f, 0x9f, 0xcf, 0xfa
	db 0x00, 0x3f, 0x7a, 0x5f, 0x8a
	db 0x00, 0x17, 0x8a, 0x3f, 0x08
	db 0x00, 0x03, 0x0f, 0x07, 0x00
	db 0x00, 0x01, 0x0f, 0x00, 0x00
	db 0x00, 0x01, 0x0f, 0x00, 0x00
	db 0x00, 0x01, 0xdf, 0x88, 0x00
	db 0x00, 0x01, 0xcf, 0xcc, 0x00
	db 0x00, 0x03, 0xcd, 0x6e, 0x00
	db 0x00, 0x13, 0x88, 0x3f, 0x00
	db 0x00, 0x13, 0x88, 0x37, 0x00
	db 0x00, 0x17, 0x00, 0x2e, 0x00
	db 0x00, 0x17, 0x80, 0x3e, 0x00

; Tile g_spr_monsters_1: 20x24 pixels, 5x24 bytes.
g_spr_monsters_1: ; defs 5 * 24
	db 0x00, 0x00, 0x33, 0xcc, 0x02
	db 0x00, 0x00, 0x33, 0xcc, 0x02
	db 0x00, 0x00, 0x37, 0xee, 0x21
	db 0x00, 0x00, 0x36, 0xe4, 0x21
	db 0x00, 0x00, 0x36, 0xe4, 0x21
	db 0x00, 0x00, 0x17, 0xee, 0x21
	db 0x00, 0x70, 0x87, 0xea, 0x21
	db 0x00, 0x70, 0x87, 0xea, 0x21
	db 0x00, 0x87, 0x4b, 0x0c, 0x21
	db 0x00, 0x87, 0x5b, 0xee, 0x30
	db 0x00, 0x87, 0x5b, 0xee, 0x30
	db 0x00, 0x87, 0x48, 0x09, 0x3f
	db 0x00, 0x87, 0x4b, 0xee, 0x03
	db 0x00, 0x87, 0x4b, 0xee, 0x03
	db 0x00, 0x87, 0x48, 0x08, 0x00
	db 0x00, 0x87, 0x4b, 0xee, 0x00
	db 0x00, 0x87, 0x4b, 0xee, 0x00
	db 0x00, 0x70, 0x82, 0x04, 0x00
	db 0x00, 0x00, 0x22, 0x44, 0x00
	db 0x00, 0x00, 0x22, 0x44, 0x00
	db 0x00, 0x00, 0x22, 0x44, 0x00
	db 0x00, 0x00, 0x22, 0x44, 0x00
	db 0x00, 0x00, 0x22, 0x44, 0x00
	db 0x00, 0x00, 0x13, 0x26, 0x00
