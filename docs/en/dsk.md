...
- `--user <number 0..15>`: Used when adding files. It sets the USER ID (0-15). By default is 0.
- `--flag-ro`: Used when adding files. It adds the READ-ONLY flag to the file.
- `--flag-sys`: Used when adding files. It adds the SYSTEM flag to the file.
