...
mxoru8_n_randoms       equ $+1
   ...
   jr   nz, mxoru8_next_rand ;; [2/3] just return the next one
...
mxoru8_next_rand:  
   ld   (mxoru8_n_randoms), a    ;; [4] | Update number of random bytes left in the buffer (+1)

   ld   hl, cpct_mxor32_seed-1   ;; [3] HL points to the byte previous to the start of the 32-bits seed 
   add  l                        ;; [1] / > HL += A
