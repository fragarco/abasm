...
read 'cpctelera/macros/cpct_opcodeConstants.asm'

cpct_getRandom_mxor_u16:

cpct_seedJump_mxor_u16:
mxoru16_next_jump:
   jr   mxoru16_generate  ;; [3] Jumps to "generate" 1 out of 2 times, to generate the next 2 random words
;; ld d,#generate         ;; [2] This instruction is modified by next code, to become LD D,xx half of the time.
   ...
   ld   hl, (cpct_mxor32_seed+0)  ;; [5] HL = second word (Most Significant one)
   ld    a, opc_JR                ;; [2] | Set initial instruction to be a JR (0x18) for next call
   ld (mxoru16_next_jump), a      ;; [4] | This will jump to "generate", to generate 2 new random words
...
mxoru16_generate:
   ...
   call cpct_nextRandom_mxor_u32  ;; [5+37] Calculate next 32-bits pseudo-random value
   ...
   ld (mxoru16_next_jump), a      ;; [4] | This is a dummy instruction set only to prevent jumping to "generate"
   ret                            ;; [3] Returns next 16-bits random value
