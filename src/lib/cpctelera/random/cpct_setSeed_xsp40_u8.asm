...
read 'cpctelera/random/cpct_getRandom_xsp40_u8.asm'

cpct_setSeed_xsp40_u8:
   ld (cpct_seed2_xsp40_u8), de ;; [6] Save first 16-bits seed from the 32-bits part (x, z values)
   ld (cpct_seed1_xsp40_u8), hl ;; [5] Save second 16-bits seed from the 32-bits part (y, w values)
   ld (cpct_seed3_xsp40_u8), a  ;; [4] Save 8-bits seed for the Weyl sequence (v value)
