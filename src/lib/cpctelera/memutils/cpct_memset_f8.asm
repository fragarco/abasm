...
cpct_memset_f8:
   ...
   ld   (msetf8_restore_sp), sp ;; [6] Save SP to recover it later on
...
msetf8_copyloop:
   ...
   push de           ;; [4]
   push de           ;; [4]
   djnz msetf8_copyloop ;; [4/3] 1 Less chunk. Continue if there still are more chuncks (B != 0)
   dec  c            ;; [1] 256 less chunks (b runned up to 0, decrement c by 1)
   jp   p, msetf8_copyloop ;; [3] Continue 256 chuncks more if C >= 0 (positive)

msetf8_restore_sp equ $+1
