...
cpct_keyboardStatusBuffer: db 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF
...
;; Matrix Line 0x00
Key_CursorUp     equ &0100  ;; Bit 0 (01h) => | 0000 0001 |
Key_CursorRight  equ &0200  ;; Bit 1 (02h) => | 0000 0010 |
Key_CursorDown   equ &0400  ;; Bit 2 (04h) => | 0000 0100 |
Key_F9           equ &0800  ;; Bit 3 (08h) => | 0000 1000 |
Key_F6           equ &1000  ;; Bit 4 (10h) => | 0001 0000 |
Key_F3           equ &2000  ;; Bit 5 (20h) => | 0010 0000 |
Key_Enter        equ &4000  ;; Bit 6 (40h) => | 0100 0000 |
Key_FDot         equ &8000  ;; Bit 7 (80h) => | 1000 0000 |
;; Matrix Line 0x01
