...
cpct_scanKeyboard_if:   ;; Assembly entry point

   ;; Configure PPI: Select Register 14 (the one connected with keyboard status) and set it for reading
   ;;
   ld  bc,  &F782           ;; [3] Configure PPI 8255: Set Both Port A and Port C as Output. 
   ...
   ld  bc,  &F40E           ;; [3] Write (0Eh = 14) on PPI 8255 Port A (F4h): the register we want to select on AY-3-8912
