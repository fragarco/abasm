...
;;
;; Assembly calls:
;;   > call cpct_enableUpperROM
;;   > call cpct_enableLowerROM
;;   > call cpct_disableUpperROM
;;   > call cpct_enableUpperROM
;;
;; Known limitations:
...
cpct_disableLowerROM:
   ld   hl, &04F6            ;; [3] HL = Machine Code. F6 04 = OR 0b00000100 = Set Bit 3 (Disable Lower ROM, 0 = enabled)
   jr mrs_modifyROMstatus    ;; [3] Jump to ROM-Modification Code

cpct_enableUpperROM:
   ld   hl, &F7E6            ;; [3] HL = Machine Code. E6 F7 = AND 0b11110111 = Reset Bit 4 (Enable Upper ROM, 0 = enabled)
   jr mrs_modifyROMstatus    ;; [3] Jump to ROM-Modification Code

cpct_disableUpperROM:
   ld   hl, &08F6            ;; [3] HL = Machine Code. F6 08 = OR 0b00001000 = Set Bit 4 (Disable Upper ROM, 0 = enabled)
...
mrs_modifyROMstatus:
   ...
   ld   hl, cpct_mode_rom_status ;; [3] HL points to present MODE, INT.GEN and ROM selection byte.
