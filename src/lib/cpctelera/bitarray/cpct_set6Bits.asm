...
g1: ;; [29]
   ...
   and &FC        ;; [2] Set last 2 bits to 0, leaving the rest untouched, A[______00]
   ...
   and &0F        ;; [2] Set first 4 bits to 0, leaving the rest untouched, A:[0000____]
...
g0: ;; [14]
   ...
   and &03        ;; [2] Set first 6 bits to 0, leaving latest 2 bits untouched A:[000000__]
...
g2: ;;[29]
   ...
   and &F0        ;; [2] Set last 4 bits to 0, leaving first 4 bits untouched A:[____0000]
   ...
   and &3F        ;; [2] Set the first 2 bits to 0, leaving last 6 bits untouched A:[00______] 
...
g3: ;; [14]
   ...
   and &C0        ;; [2] Set the last 6 bits to 0, leaving first 2 bits untouched A:[__000000]
