...
cpct_getBit:
   ...
   ld    a, &37   ;; [2] A = 0x37 = 0b00110111 => cpl(0x46) rotated right 3 bits (0x46 is part of bit 0,(hl) instruction, 0xCB46)
   srl   h        ;; [2] / HL /= 2
   ...
   ld (getbit_instr), a ;; [4] Modify bit instruction to test our target bit
