...
;;   call cpct_etm_drawTileRow2x4 ;; Finally, call the function
;; (end code)
;;
...
dtr_restore_ptileset: ;; set_tileset must be called before using this function
   ...
   push de                         ;; [4] Save DE'
   call cpct_drawTileAligned2x4_f  ;; [5+59] Draw the tile
   pop  de                         ;; [3] Restore DE'
   ...
   djnz etmdr24_drawtiles_width ;; [2/3] IF A!=0, continue with next tile from this line
