...
;;    > call cpct_etm_drawTilemap2x4_f
;;
...
cpct_etm_drawTilemap2x4_f:
   ...
   jr  etmdtrf_set_HLp_nextRow ;; [3] Start drawing the first row of tiles

etmdtrf_drawtiles_height:
   ...
   jr nz, etmdtrf_set_HLp_nextRow ;; [2/3] Not 0 => Pixel Line 4 => No need to adjust
...
etmdtrf_set_HLp_nextRow:
   ...
   call cpct_etm_drawTileRow2x4 ;; [7 + 103B'] Draws the next tile Row (B' holds the width of the tilerow)

   dec  c              ;; [1] 1 less tile row to draw
   jr  nz, etmdtrf_drawtiles_height ;; [2/3] If there still are some tile rows to draw (C!=0), continue
