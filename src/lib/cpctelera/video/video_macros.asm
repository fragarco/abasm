...
;;
macro cpctm_memPage6 REG8, PAGE 
...
;;
;; ASM Definition:
;;    .macro <cpctm_screenPtr> *SYM*, *VMEM*, *X*, *Y*
;;
;; Parameters:
...
;;
;; Recommendations:
;;    All constant values - Use this macro <cpctm_screenPtrSym> or <cpctm_screenPtr> 
;;    Any variable value  - Use the function <cpct_getScreenPtr>
;;
macro cpctm_screenPtrSym SYM, VMEM, X, Y 
...
;;
macro cpctm_setCRTCReg _HEXREG, _HEXVAL
   ld    bc, &BC_HEXREG  ;; [3] B=0xBC CRTC Select Register, C=register number to be selected
   out  (c), c           ;; [4] Select register
   ld    bc, &BD_HEXVAL  ;; [3] B=0xBD CRTC Set Register, C=Value to be set
...
;; is called when using <cpctm_setBorder> (It is called using 16 as *pen*
