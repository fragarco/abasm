...
read 'cpctelera/video/videomode.asm'
...
wvss_while_active:
   ...
   jr     c, wvss_while_active  ;; [2/3] Loop While Carry On (VSYNC is active)
...
wvss_while_inactive: 
   ...
   jr wvss_while_inactive       ;; [3] VSYNC is still inactive, wait for it to activate
