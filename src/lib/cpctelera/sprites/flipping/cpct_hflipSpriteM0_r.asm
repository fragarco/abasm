...
hfspm0r_nextrow:
   ...
   jr  hfspm0r_first ;; [3] Jump to start processing present sprite row
...
hfspm0r_first:
   ...
   jr   z, hfspm0r_end ;; [2/3] If B=0, this was the last byte to be reversed, son got to end
   ...
   djnz hfspm0r_nextbyte ;; [3/4] B--, if B!=0, continue reversing next byte
...
hfspm0r_end:
   ...
   jr   nz, hfspm0r_nextrow ;; [2/3] If H!=0, process next sprite row, as there are more
