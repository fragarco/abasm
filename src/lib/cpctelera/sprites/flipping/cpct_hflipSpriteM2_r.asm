...
hfspm2r_nextrow:
   ...
   jr  hfspm2r_first ;; [3] Jump to start processing present sprite row
...
hfspm2r_first:
   ...
   jr   z, hfspm2r_end ;; [2/3] If B=0, this was the last byte to be reversed, son got to end
   ...
   djnz hfspm2r_nextbyte ;; [3/4] B--, if B!=0, continue reversing next byte
...
hfspm2r_end:
   ...
   jr   nz, hfspm2r_nextrow ;; [2/3] If H!=0, process next sprite row, as there are more
