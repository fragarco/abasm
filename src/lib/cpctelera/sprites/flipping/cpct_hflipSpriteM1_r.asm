...
hfspm1r_nextrow:
   ...
   jr  hfspm1r_first ;; [3] Jump to start processing present sprite row
...
hfspm1r_first:
   ...
   jr   z, hfspm1r_end ;; [2/3] If IXH=0, this was the last byte to be reversed, son got to end
   ...
   djnz hfspm1r_nextbyte  ;; [3/4] B--, if B!=0, continue reversing next byte
...
hfspm1r_end:
   ...
   jr   nz, hfspm1r_nextrow ;; [2/3] If H!=0, process next sprite row, as there are more
