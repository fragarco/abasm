...
;;    > ld   bc, &0103         ;; B = *px1* = 1, C = *px0* = 3 (Firmware colours)
;;    > ld   de, &0200         ;; D = *px3* = 2, E = *px2* = 0 (Firmware colours)
;;    > push de                  ;; Put parameters on the stack (in reverse order, always)
;;    > push bc                  ;; 
;;    > call cpct_px2byteM1      ;; Call the function on the C entry point
...
cpct_px2byteM1:
   ...
   jr   nc, px2bm1_loop1 ;; [2/3] If fC is set...
...
px2bm1_px1_repeat:
   ...
   rra                   ;; [1] Shift to the right, the bit 0 (low bit of pixel) is stored into fC
   jr   nc, px2bm1_loop2 ;; [2/3] If fC is set...
   or    c               ;; [1] ... set the low bit into high nibble
px2bm1_loop2:
   djnz px2bm1_px1_repeat;; [3/4] Repeat until B=0 (until 2 pixels have been converted)
   ...
   jr   nc, px2bm1_loop3 ;; [2/3] If fC is set...
   or    c               ;; [1] ... set the low bit into high nibble
px2bm1_loop3:
