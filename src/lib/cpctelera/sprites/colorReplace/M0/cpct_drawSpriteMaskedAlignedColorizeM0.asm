...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;
;; Function: drawSpriteMaskedAlignedColorizeM0
;;
...
;;    > call drawSpriteMaskedAlignedColorizeM0
;;
...
dspmacm0_aligned_mask_table equ $+1 
  ld     hl, 0000  ;; [3] HL = Aligned mask table for transparencies (placeholder)
   ...
   jp    nz, dspmacm0_width_loop ;; [2/3] While not 0, we are still painting this sprite line 
   
   pop   de        ;; [3] Restore DE start line (DestMem)   
   dec   b         ;; [1] --B holds sprite height. We decrease it to count another pixel line finished
   jp    z, dspmacm0_end_sprite_colourize ;; [2/3] If 0, we have finished the last sprite line.
   ...
   jp    nz, dspmacm0_height_loop  ;; [2/3] .. by checking the 4 bits that identify present memory line. 
   ...
   jp    dspmacm0_height_loop ;; [3] Jump to continue with next pixel line 

dspmacm0_end_sprite_colourize:
   ret      
