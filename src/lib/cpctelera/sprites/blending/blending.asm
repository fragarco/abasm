...
CPCT_BLEND_XOR equ &AE
CPCT_BLEND_AND equ &A6
CPCT_BLEND_OR  equ &B6
CPCT_BLEND_ADD equ &86
CPCT_BLEND_ADC equ &8E
CPCT_BLEND_SBC equ &9E
CPCT_BLEND_SUB equ &96
CPCT_BLEND_LDI equ &7E
CPCT_BLEND_NOP equ &00
