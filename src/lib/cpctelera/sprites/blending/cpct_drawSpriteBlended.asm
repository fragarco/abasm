...
cpct_dsb_blendFunction:
   ...
   djnz  dspb_width_loop;; [3/4] B holds sprite width. Decrease it and loop until B=0
   ...
   jr    z,dspb_copy_ended ;; [2/3] If 0, we have finished the last sprite line.
   ...
   jr   nz,dspb_height_loop ;; [2/3]  by checking the 4 bits that identify present memory line. (......11 1.......)
                            ;; ....  If 0, we have crossed boundaries

dspb_8bit_boundary_crossed:
   ...
   jr  dspb_height_loop ;; [3] Jump to continue with next pixel line
