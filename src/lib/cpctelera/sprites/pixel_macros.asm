...
;;
;; ASM Definition:
;;    macro <CPCTM_PEN2PIXELPATTERN_M0> *SYM*, *PEN*
;;
;; Parameters:
...
;;       CPCTM_PEN2PIXELPATTERN_M0 OldPen, 1 ;// Produces 'OldPen = 0xF0'
;;       CPCTM_PEN2PIXELPATTERN_M0 NewPen, 2 ;// Produces 'NewPen = 0x0F'
;;       ld    de, (OldPen << 8) | NewPen
;;       call  cpct_spriteColourizeM0
;;       ret
;;    
...
;;       CPCTM_PEN2PIXELPATTERN_M0 OldPen, 2 ;// Produces 'OldPen = 0x0F'
;;       CPCTM_PEN2PIXELPATTERN_M0 NewPen, 1 ;// Produces 'NewPen = 0xF0'
;;       ld    de, (OldPen << 8) | NewPen
;;       call  cpct_spriteColourizeM0
;;       ret
;; (end code)
;;
mdelete CPCTM_PEN2PIXELPATTERN_M0
macro CPCTM_PEN2PIXELPATTERN_M0 _Sym, _Pen
   _Sym equ ( ( ((((_Pen) & 1) << 6) | (((_Pen) & 2) << 1) | (((_Pen) & 4) << 2) | (((_Pen) & 8) >> 3) ) << 1 ) | ( (((_Pen) & 1) << 6) | (((_Pen) & 2) << 1) | (((_Pen) & 4) << 2) | (((_Pen) & 8) >> 3) ) )
endm
...
;;
;; C Definition:
;;    macro <CPCTM_PENS2PIXELPATTERNPAIR_M0> *SYM*, *OldPen*, *NewPen*
;;
;; Parameters:
;;    SYM    - Name of a symbol to assign the resulting value of the calculation
;;    OldPen - ([0-15], unsigned) Pen Colour to be found and replaced in <cpct_spriteColourizeM0>
;;    NewPen - ([0-15], unsigned) New Pen Colour to be inserted in <cpct_spriteColourizeM0>
;; 
;; Known limitations:
;;    * It does not perform any kind of checking. Values other than unsigned integers [0-15]
;; will produce undefined behaviour.
...
;; ;// BC = Size of Alien Sprite
;; changeAlienSkinColourToCyan:
;;    CPCTM_PENS2PIXELPATTERNPAIR_M0 rplcPat, 1, 2   ;// Change Pen 1 into Pen 2
...
;; ;// BC = Size of Alien Sprite
;; restoreAlienSkinColourToYellow:
;;    CPCTM_PENS2PIXELPATTERNPAIR_M0 rplcPat, 2, 1   ;// Change Pen 2 into Pen 1
;;    ld    de, rplcPat                              ;// rplcPat = 0x0FF0
;;    call  cpct_spriteColourizeM0
;;    ret
;; (end code)
;;
mdelete CPCTM_PENS2PIXELPATTERNPAIR_M0
macro CPCTM_PENS2PIXELPATTERNPAIR_M0 _Sym, _OldPen, _NewPen
   CPCTM_PEN2PIXELPATTERN_M0 _Sym__h, _OldPen
   CPCTM_PEN2PIXELPATTERN_M0 _Sym__l, _NewPen
   _Sym equ (_Sym__h << 8) | _Sym__l
endm
...
;;
;; ASM Definition:
;;    macro <CPCTM_PEN2PIXELPATTERN_M1> *SYM*, *PEN*
;;
;; Parameters:
;;    SYM - Name of a symbol to assign the resulting value of the calculation
...
;;    ;// BC = Size of Alien Sprite
;;    changeAlienSkinColourToCyan:
;;       CPCTM_PEN2PIXELPATTERN_M1 OldPen, 1 ;// Produces 'OldPen = 0xF0'
;;       CPCTM_PEN2PIXELPATTERN_M1 NewPen, 2 ;// Produces 'NewPen = 0x0F'
;;       ld    de, (OldPen << 8) | NewPen
;;       call  cpct_spriteColourizeM1
;;       ret
;;    
;;    ;// Simple function that restores the Skin Colour 
;;    ;// of a given Alien Sprite to yellow (after being changed to Cyan)  
...
;;    ;// BC = Size of Alien Sprite
;;    restoreAlienSkinColourToYellow:
;;       CPCTM_PEN2PIXELPATTERN_M1 OldPen, 2 ;// Produces 'OldPen = 0x0F'
;;       CPCTM_PEN2PIXELPATTERN_M1 NewPen, 1 ;// Produces 'NewPen = 0xF0'
;;       ld    de, (OldPen << 8) | NewPen
;;       call  cpct_spriteColourizeM1
;;       ret
;; (end code)
;;
mdelete CPCTM_PEN2PIXELPATTERN_M1
macro CPCTM_PEN2PIXELPATTERN_M1 _Sym, _Pen
...
;;
;; C Definition:
;;    macro <CPCTM_PENS2PIXELPATTERNPAIR_M1> *SYM*, *OldPen*, *NewPen*
;;
;; Parameters:
;;    SYM    - Name of a symbol to assign the resulting value of the calculation
...
;; ;// BC = Size of Alien Sprite
;; changeAlienSkinColourToCyan:
;;    CPCTM_PENS2PIXELPATTERNPAIR_M1 rplcPat, 1, 2   ;// Change Pen 1 into Pen 2
;;    ld    de, rplcPat                              ;// rplcPat = 0xF00F
;;    call  cpct_spriteColourizeM1
;;    ret
;;
...
;; ;// BC = Size of Alien Sprite
;; restoreAlienSkinColourToYellow:
;;    CPCTM_PENS2PIXELPATTERNPAIR_M1 rplcPat, 2, 1   ;// Change Pen 2 into Pen 1
;;    ld    de, rplcPat                              ;// rplcPat = 0x0FF0
;;    call  cpct_spriteColourizeM1
;;    ret
;; (end code)
;;
mdelete CPCTM_PENS2PIXELPATTERNPAIR_M1
macro CPCTM_PENS2PIXELPATTERNPAIR_M1 _Sym, _OldPen, _NewPen
   CPCTM_PEN2PIXELPATTERN_M1 _Sym__h, _OldPen
   CPCTM_PEN2PIXELPATTERN_M1 _Sym__l, _NewPen
   _Sym equ (_Sym__h << 8) | _Sym__l
endm  
