...
;;    > call cpct_drawSpriteMaskedAlignedTable
;;
...
cpct_drawSpriteMaskedAlignedTable:
   ...
   ld (dmsat_restore_ixl + 2), a ;; [4] Save IXL (widht of the sprite) in a placeholder for recovering it later

dmsat_sprite_height_loop:
   push de         ;; [4] Save DE for later use (jump to next screen line)

dmsat_sprite_width_loop:
   ...
   jr   nz,dmsat_sprite_width_loop ;; [2/3] While not 0, we are still painting this sprite line 
   ...
   jr    z,dmsat_sprite_copy_ended ;; [2/3] If 0, we have finished the last sprite line.
...
dmsat_restore_ixl:
   ...
   jr   nz, dmsat_sprite_height_loop ;; [2/3]  by checking the 4 bits that identify present memory line. 
                                     ;; ....  If 0, we have crossed boundaries

dmsat_sprite_8bit_boundary_crossed:
   ...
   jr  dmsat_sprite_height_loop ;; [3] Jump to continue with next pixel line

dmsat_sprite_copy_ended:
   ret      ;; [3] Return
