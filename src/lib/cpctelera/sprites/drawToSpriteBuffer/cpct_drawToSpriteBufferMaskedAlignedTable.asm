...
cpct_drawToSpriteBufferMaskedAlignedTable:
   ...
   ld (dtspbmat_offset_to_next_line), a   ;; [4] Modify the offset size inside the copy loop
   ...
   ld (dtspbmat_sprite_width), a    ;; [4] Save sprite width into its copy_loop placeholder

   ;; Perform the copy	 
   dtspbmat_copy_loop:
     dtspbmat_sprite_width equ $+2 ;; Placeholder location for sprite_width
      ...
      jr nz, dtspbmat_line_loop  ;; [2/3] While not 0, we are still painting this sprite line 
     ...
     dtspbmat_offset_to_next_line equ $+1
   ...
   jr nz, dtspbmat_copy_loop     ;; [2/3] Repeat copy_loop if IXH!=0 (Iterations pending)
