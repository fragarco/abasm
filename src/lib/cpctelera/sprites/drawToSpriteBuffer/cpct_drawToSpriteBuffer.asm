...
cpct_drawToSpriteBuffer:
   ...
   ld (dtspb_offset_to_next_line), a ;; [4] Modify the offset size inside the copy loop
   ...
   ld (dtspb_sprite_width_restore), a ;; [4] Set the sprite width inside the copy loop
   ...
   dtspb_copy_loop:
      ...
      dtspb_sprite_width_restore equ $+1
      ...
      dtspb_offset_to_next_line equ $+1
   ...
   jr  nz, dtspb_copy_loop ;; [2/3] Repeat copy_loop if A!=0 (Iterations pending)
