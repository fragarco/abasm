...
;;
;; Required memory:
;;    C-bindings  - 27 bytes (+38 bytes from <cpct_drawCharM2_inner> = 65 bytes)
;;  ASM-bindings  - 23 bytes (+38 bytes from <cpct_drawCharM2_inner> = 61 bytes)
;;
;; Time Measures:
;; (start code)
...
cpct_drawCharM2:
   ...
   call   cpct_drawCharM2_inner     ;; [5+137/155] Does the actual drawing to screen
