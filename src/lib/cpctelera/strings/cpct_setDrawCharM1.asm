...
read 'cpctelera/strings/cpct_dc_mode1_ct.asm'
...
sdchm1_loop:
   ...
   and   &BB      ;; [2] | Insert FG Colour in the 2nd bit of each nibble: 0xCC = [1011|1011]
   ...
   and   &99      ;; [2] | Insert FG Colour in the 2nd and 3rd bits of each nibble: 0x99 = [1001|1001]
   xor    c       ;; [1] \ C = 4 foreground pixel values
