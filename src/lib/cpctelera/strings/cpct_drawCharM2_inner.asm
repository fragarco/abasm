...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;
;; Function: cpct_drawCharM2_inner
;;
...
cpct_charm2imc equ dchm2i_nextrow

cpct_drawCharM2_inner:
   ...
   ld     d, &07     ;; [2] B = 0x07, because 0x07 * 8 = 0x38, (high byte of 0x3800)
   ...
   ld     bc, &0808   ;; [3] B = Counter for the 8 lines of the character to be copied
...
dchm2i_nextpixelline:
   ...
   jr    nz, dchm2i_nextrow ;; [2/3]  by checking the 4 bits that identify present memory line. 
                     ;; .... If 0, we have crossed boundaries
dchm2i_boundary_crossed:
   ld     a, &50   ;; [2] / 
   ...
   adc    h          ;; [1] |
   ld     h, a       ;; [1] \
   jr     dchm2i_nextrow ;; [3] Jump to continue with next pixel line
