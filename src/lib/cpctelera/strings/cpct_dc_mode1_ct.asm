...
;;
dc_mode1_ct:
        db &00	;; PEN 0: All pixels are coloured 00
		db &F0	;; PEN 1: All pixels are coloured 01 (right nibble, 4 zeros for the 4 pixels, left nibble 4 ones)
		db &0F  ;; PEN 2: All 4-pixels are coloured 10 (similar to previous element, but inverted)
		db &FF	;; PEN 3: All 4-pixels are coloured 11, so all bits are 1.
