...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;
;; Function: cpct_drawCharM0_inner
;;
...
cpct_drawCharM0_inner:
   ...
   and   &07      ;; [2] Isolate latest 3 bits of a |00000hgf|
   or    &38      ;; [2] Add the 3 ones in front, so that the address starts at 0x38xx => |00111hgf|
   ld__ixh_a      ;; [2] Save it to IXH = |00111hgf|
   ld    a, e     ;; [1] Restore A status after 3*RLCA => |edcba|hgf|
   and   &F8      ;; [2] Isolate first 5 bits => |edcba|000|
...
dchm0i_endpixelline:
   ...
   and   &07         ;; [2] ... then L % 8 == 0, as it is 8-byte-aligned. 
...
;;
dc_2pxtableM0: db &00, &40, &80, &C0   ;; Default colours BG=0, FG=1
