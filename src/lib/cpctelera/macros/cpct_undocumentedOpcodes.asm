...
mdelete jr__0
macro jr__0
   dw &0018  ;; JR 00 (Normally used as a modifiable jump, as jr 0 is an infinite loop)
endm
...
mdelete ld__ixl
macro ld__ixl    Value 
   db &DD, &2E, Value  ;; Opcode for ld ixl, Value
endm
...
mdelete  ld__ixh
macro ld__ixh    Value 
   db &DD, &26, Value  ;; Opcode for ld ixh, Value
endm
...
mdelete  ld__iyl
macro ld__iyl    Value 
   db &FD, &2E, Value  ;; Opcode for ld iyl, Value
endm
...
mdelete  ld__iyh
macro ld__iyh    Value 
   db &FD, &26, Value  ;; Opcode for ld iyh, Value
endm
